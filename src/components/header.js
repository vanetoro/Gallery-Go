        ...
        {/* <!--Header & Branding region--> */}
          ...
          <div className="header-inner container">
            ...
            <div className="header-brand flex-column align-items-start">
              ...
              <div className="header-slogan d-none d-lg-block text-xs font-weight-normal"><em>Daily Fresh News</em></div>
            </div>
            ...
            <div className="w-100 bg-primary navbar-dark">
              ...
              <div className="container d-none d-lg-flex align-items-center px-0 py-2 py-lg-0">
                ...
                <div className="sticky-effect-fade-in sticky-effect-expand-w d-flex align-items-center">
                  <a href="#" className="h4 text-white my-0 ml-3 mr-4 py-2">App<span className="font-weight-normal">Strap</span></a>
                </div>
